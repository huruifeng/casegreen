    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_lin_lb'
            )
        ]
...
class case_status_msc_lb(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_msc_lb'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_src_lb(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_src_lb'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_wac_lb(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_wac_lb'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_eac_lb(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_eac_lb'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_ysc_lb(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_ysc_lb'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_lin_sc(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_lin_sc'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_msc_sc(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_msc_sc'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_src_sc(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_src_sc'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_wac_sc(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_wac_sc'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_eac_sc(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_eac_sc'
            )
        ]
    def action_days_to_now(self):
        days = (datetime.date(datetime.now()) - self.action_date_x).days
...
class case_status_ysc_sc(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_ysc_sc'
            )
        ]
...
class case_status_ioe(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['receipt_number', 'status','action_date_x'], name='unique_receipt_status_datex_ioe'
            )
        ]
